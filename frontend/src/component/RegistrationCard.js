...
import axios from "axios";
  ...
  class RegisCard extends React.Component{
    ...
    loginuser= (details) => {
      var self = this;
        ...
        console.log(details);         
      axios.post("https://hirehelper-api.azurewebsites.net/login/user",
    ...
    loginagency= (details) => {
      var self = this;
        ...
        console.log(details);         
      axios.post("https://hirehelper-api.azurewebsites.net/login/agent",
      details)
      ...
      userregistration = (member) => {
        var self = this;
          ...
          console.log(member);         
        axios.post("https://hirehelper-api.azurewebsites.net/register/user",
                    member)
                .then(function(response) {                  
                    console.log("response" + JSON.stringify(response.data));
      ...
      agencyregistration =(details)=>{
        ...
        console.log(details);
        axios.post("https://hirehelper-api.azurewebsites.net/register/agent", details).then(function(response) {
            self.setState({
  ...
  <Card.Body>
    ...
    <Form onSubmit={this.handlelogin}>
     ...
     <div>
        <div><b>New to our site ,please choose one :</b></div>
          <div>If you are looking for someone to hire , please choose "User", If you are here to register as an agency , choose "Agency" </div>
        <button className="btn btn-default" onClick={this.regisClicked}>
          User
        </button>
        <button className="btn btn-default" onClick={this.agencyregisClicked}>
         Agency
        </button>
        </div>
   </Card.Text>
