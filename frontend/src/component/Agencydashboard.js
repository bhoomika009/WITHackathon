  ...
  class Agencydashboard extends React.Component{
    constructor() {
      ...
      submitForm = (details) => {
        ...
        console.log(details);
        axios.post("https://hirehelper-api.azurewebsites.net/helpers/add", details).then(function(response) {
    ...
    uploadcertificate(event){
        ...
        axios.post("https://hirehelper-api.azurewebsites.net/uploadCertificate", formData).then(function(response) {
            if(response.status === 200){
            self.setState({
