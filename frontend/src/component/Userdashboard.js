...
class Userdashboard extends React.Component{
    constructor(props) {
      ...
      gethired(event){
        ...
        axios.get("https://hirehelper-api.azurewebsites.net/user/helpers"+"/"+loggedinuserid
      ...
      formSearch(event){
        ...
        var self = this;
        axios.post("https://hirehelper-api.azurewebsites.net/helpers/searchByCategory",
        post_data, {
          headers: {
      ...
      showHireModal(event, row){
        ...
        var helperid = row.id;
        var loggedinuserid = sessionStorage.getItem("userloginid");
        axios.get("https://hirehelper-api.azurewebsites.net/helpers/hire"+"/"+loggedinuserid+"/"+helperid
        ).then(function(response) {                  
                    console.log("response" + JSON.stringify(response.data));
                    console.log("response status" + JSON.stringify(response.status));
                    if (response.status === 200) {
      ...
      viewcertificate(event){
        ...
        event.preventDefault();  
          const fileURL = "https://hirehelper-api.azurewebsites.net/downloadCertificate/1";     
